...
class _ScoreHistoryScreenState extends State<ScoreHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        //contents of score history screen
        body: Column(
          children: [
            Text(
              "Your Score Sheet",
            ...
            Expanded(
              child: StreamBuilder(
                  ...
                  builder: (BuildContext context,
                    ...
                    //display of list of score using listview and score from cloud firestore
                    return ListView.builder(
                        itemCount: scoreData.size,
                        itemBuilder: (context, index) {
                          //comparison of logged in user email with email cloud firestore email and returns score of particular email
                          ...
                          //if no score is found of email, return no score text
